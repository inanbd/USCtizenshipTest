...
/// The official USCIS 128 civics questions (2025 version).
///
/// Source: USCIS "128 Civics Questions and Answers (2025 version)",
/// M-1778 (09/25). This is the test taken by anyone who filed Form N-400 on or
/// after 20 October 2025.
///
/// It shares its numbering, structure and 65/20 asterisks with the 2020 set,
/// but USCIS revised eight questions: 31, 33, 41, 48, 68, 97, 118 and 126.
/// Those are marked with a "2025:" comment below.
///
...
const List<Question> kQuestions2025 = [
  // ---- American Government: Principles of American Government ----
  Question(
    id: 1,
    version: TestVersion.v2025,
  ...
  Question(
    ...
    // 2025: adds the "People of..." phrasing.
  ...
  Question(
    ...
    // 2025: adds the "People..." phrasings.
    answers: [
  ...
  Question(
    ...
    answers: [
      ...
      'Chief diplomat',
      // 2025: appointing federal judges added as a presidential power.
  ...
  Question(
    ...
    // 2025: "Secretary of War (Defense)" replaces "Secretary of Defense", the
    // Vice President is listed as "Vice-President", and six agency heads are
    // added.
    answers: [
      'Attorney General',
  ...
  Question(
    ...
    // 2025: both routes now carry their statutory conditions.
    answers: [
  ...
  Question(
    ...
    category: QuestionCategory.americanHistory,
    section: '1800s',
    // 2025: rewritten to the full 14th Amendment wording.
    prompt:
        'What amendment says all persons born or naturalized in the United '
        'States, and subject to the jurisdiction thereof, are U.S. citizens?',
  ...
  Question(
    ...
    answers: [
      'Light bulb',
      // 2025: "combustible" corrected to "internal combustion".
  ...
  Question(
    ...
    answers: [
      ...
      'Memorial Day',
      // 2025: Juneteenth added to the national holidays.
      'Juneteenth',
      'Independence Day',
      'Labor Day',
      'Columbus Day',
